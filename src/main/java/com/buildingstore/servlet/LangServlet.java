...
/**
 * Переключение языка интерфейса. Адрес: GET /lang?l=en&back=/путь
...
public class LangServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        Lang lang = Lang.from(req.getParameter("l"));

        Cookie cookie = new Cookie(WebUtils.LANG_COOKIE, lang.getCode());
        cookie.setPath("/");
